...
def process_query(prompt):
    ...
    # Call the memory query handler
    results, summary = memory_query_handler.process_query(prompt)
...
def main():
    ...
    with tab1:
        ...
        1. Enhance it with creative details
        2. Generate an image
        ...
        if st.button("Generate", key="generate_button"):
            if not prompt:
                ...
                result = process_creation(prompt)
    ...
    with tab2:
        ...
        if st.button("Search", key="search_button"):
            if not search_prompt:
                ...
                results, summary = process_query(search_prompt)
    ...
    st.sidebar.info(
        ...
        which uses Openfabric's AI services to turn text prompts 
        into images and 3D models.
        
        The app features:
        - Local LLM for prompt enhancement
        - Text-to-Image generation
        - Image-to-3D model conversion
        - Memory system for past creations
        
        Note: This is using mock services for demonstration purposes.
        """
    )
